...
## 理解Django的模板语言特点
是时候谈谈MTV模板三件套中的第三个家伙了。而你的团队或许有关心模板设计的设计者。或者你想要自己设计模板。无论选择哪种方式，你都需要对它们非常熟悉。毕竟，模板是直接面向用户的。  
...
## Support for other template languages 对其他模板语言的支持 
...
可选的是，你可以使用其中一个拥有Bootstrap支持的cookiecutter模板。  
...
## But they all look the same! 怎么它们看上去都一个样啊！
